...
import { Frame } from '../../src/surfaces/tui/components/Frame.js'
import { Row } from '../../src/surfaces/tui/components/Row.js'
import { Section, SectionEnd } from '../../src/surfaces/tui/components/Section.js'
...
describe('responsive layout', () => {
  it('keeps the welcome menu inside a 60x18 frame', () => {
    ...
    expect(frame).toContain('1-4 of 12')
    assertFits(frame, 60)
    unmount()
  })
