...
export const en = {
  ...
  'agentControl.restartHint': 'restart them (new session) to load the tools',
  ...
  'web.mcpRestartHint': 'Restart {{names}} (start a new session) to load the tools.',
  ...
  'web.mcpVerifyFailed': 'Attached, but the server did not start here: {{detail}}. A host CLI will hit the same error; check that reevesagents is installed.',
  'web.model': 'Model',
