...
const CONTENT: ReferenceItem[] = [
  ...
  { type: 'row', primary: 'New Run', trailing: 'create a multi-agent tmux workspace' },
  { type: 'row', primary: 'Spawner', trailing: 'multiple independent CLI agents; human coordinates' },
  ...
  { type: 'row', primary: 'spawn', trailing: 'start a low-permission multi-agent workspace' },
  ...
  { type: 'row', primary: 'Agent', trailing: 'independent provider CLI inside the run session' },
