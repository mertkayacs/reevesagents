// Run › Agents list: displays only real agents in this run.
// Frame + List template with root first, then workers.
// Paginates agent rows when the list exceeds available terminal height.
